...
<body>
                                        ...
                                        if( have_posts() )
                                        {
                                            while( have_posts() )
                                            {
                                                ...
                                                <div class="post-item">
                                                    ...
                                                    <div class="post-content"><img class="avatar" src="http://blog.zhangchongen.cn/wp-content/themes/Clblogs_theme_home/assets/img/photo_test.png"><? the_content(); ?>
                                                    </div>
    ...
    <script src="http://blog.zhangchongen.cn/wp-content/themes/Clblogs_theme_home/assets/js/jquery.min.js"></script>
    <script src="http://blog.zhangchongen.cn/wp-content/themes/Clblogs_theme_home/assets/bootstrap/js/bootstrap.min.js"></script>
</body>
